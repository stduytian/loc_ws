...
static bool livox_ros_driver2__msg__CustomMsg__rosidl_typesupport_introspection_c__CustomMsg_key_members_array[6] = {
  false,
  false,
  false,
  false,
...
static const rosidl_typesupport_introspection_c__MessageMembers livox_ros_driver2__msg__CustomMsg__rosidl_typesupport_introspection_c__CustomMsg_message_members = {
  ...
  livox_ros_driver2__msg__CustomMsg__rosidl_typesupport_introspection_c__CustomMsg_key_members_array // mapping to each field to know whether it is keyed or not
};
