...
static bool fast_lio__msg__Pose6D__rosidl_typesupport_introspection_c__Pose6D_key_members_array[6] = {
  false,
  false,
  false,
  false,
...
static const rosidl_typesupport_introspection_c__MessageMembers fast_lio__msg__Pose6D__rosidl_typesupport_introspection_c__Pose6D_message_members = {
  ...
  fast_lio__msg__Pose6D__rosidl_typesupport_introspection_c__Pose6D_key_members_array // mapping to each field to know whether it is keyed or not
};
