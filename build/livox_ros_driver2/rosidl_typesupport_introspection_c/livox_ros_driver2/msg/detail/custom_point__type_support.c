...
static bool livox_ros_driver2__msg__CustomPoint__rosidl_typesupport_introspection_c__CustomPoint_key_members_array[7] = {
  false,
  false,
  false,
  false,
...
static const rosidl_typesupport_introspection_c__MessageMembers livox_ros_driver2__msg__CustomPoint__rosidl_typesupport_introspection_c__CustomPoint_message_members = {
  ...
  livox_ros_driver2__msg__CustomPoint__rosidl_typesupport_introspection_c__CustomPoint_key_members_array // mapping to each field to know whether it is keyed or not
};
