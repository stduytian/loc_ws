...
size_t get_serialized_size_key(
  ...
  size_t current_alignment);
size_t
max_serialized_size_key_ScoutLightState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    for (size_t i = 0; i < 4; i++) {
      scout_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.actuator_states[i],
        cdr);
    }
    }
  ...
  size_t current_alignment)
{
  ...
  // Member: actuator_states
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        scout_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.actuator_states[index], current_alignment);
    }
  }
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_scout_msgs
max_serialized_size_key_ScoutStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: actuator_states
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        scout_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_ScoutActuatorState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: front_light_state
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        scout_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_ScoutLightState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
