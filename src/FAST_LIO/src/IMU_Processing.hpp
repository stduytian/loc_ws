...
void ImuProcess::IMU_init(const MeasureGroup &meas, esekfom::esekf<state_ikfom, 12, input_ikfom> &kf_state, int &N)
{
  ...
  double pitch_rad = std::asin(R_wi(2, 0));
  double pitch_deg = pitch_rad * 180.0 / M_PI;
  double roll_rad = std::atan2(R_wi(2, 1), R_wi(2, 2));
  double roll_deg = roll_rad * 180.0 / M_PI;
  std::cout << "Pitch angle: " << pitch_rad << " degrees: " << pitch_deg << std::endl;
  std::cout << "Roll angle: " << roll_rad << " degrees: " << roll_deg << std::endl;
